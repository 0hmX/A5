...
export const Colors = {
  light: {
    ...
    tint: 'oklch(0.623 0.214 259.815)', // primary
    ...
    icon: '#687076', // from old Colors.ts
    tabIconDefault: '#687076', // from old Colors.ts
    tabIconSelected: 'oklch(0.623 0.214 259.815)', // primary
  ...
  dark: {
    ...
    tint: 'oklch(0.546 0.245 262.881)', // primary
    ...
    icon: '#9BA1A6', // from old Colors.ts
    tabIconDefault: '#9BA1A6', // from old Colors.ts
    tabIconSelected: 'oklch(0.546 0.245 262.881)', // primary
